...
from public_api.models import Paper, PaperCitation

def populate_citations():
    """
    Populate citation data for papers
    """
    papers = Paper.objects.all()
    print(f"Found {papers.count()} papers in public_api")
...
if __name__ == "__main__":
    print("Starting citation population script...")
    populate_citations()
    print("Done!") 